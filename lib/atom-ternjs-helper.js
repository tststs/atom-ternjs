...
export function prepareInlineDocs(documentation) {

  const result = doctrine.parse(`/**${documentation}*/`, {
  ...
  if (result.tags.length === 0) {
    ...
    documentation = documentation && documentation.replace(/(?:\r\n|\r|\n)/g, '<br />');

  } else {

    documentation = buildJSDocMarkup(documentation);
  }

  return documentation;
}

function buildJSDocMarkup(documentation) {
