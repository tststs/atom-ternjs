...
export default class Provider {
  ...
  init() {
    ...
    this.excludeLowerPriority = manager.packageConfig.options.excludeLowerPriorityProviders;
      ...
      manager.client.update(editor).then((data) => {
        ...
        manager.client.completions(atom.project.relativizePath(editor.getURI())[1], {
          ...
          for (let obj of data.completions) {
            ...
            obj = manager.helper.formatTypeCompletion(obj, isInFunDef);
            ...
            if (manager.packageConfig.options.useSnippetsAndFunction && obj._hasParams) {
