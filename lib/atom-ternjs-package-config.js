...
class PackageConfig {
  ...
  registerEvents() {
    ...
    this.disposables.push(atom.config.observe('atom-ternjs.ternServerGetFileAsync', (value) => {

      this.options.ternServerGetFileAsync = value;
    }));

    this.disposables.push(atom.config.observe('atom-ternjs.ternServerDependencyBudget', (value) => {

      this.options.ternServerDependencyBudget = value;
    }));

    this.disposables.push(atom.config.observe('atom-ternjs.inlineFnCompletionDocumentation', (value) => {

      this.options.inlineFnCompletionDocumentation = value;
    }));
