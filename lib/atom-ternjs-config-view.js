...
class ConfigView extends HTMLElement {
  ...
  buildOptionsMarkup(manager) {
    ...
    this.contentElement.appendChild(this.buildBoolean('libs', projectConfig.libs));
    ...
    this.contentElement.appendChild(this.buildBoolean('plugins', projectConfig.plugins));
  }
  ...
  buildSection(sectionTitle) {
    ...
    const docs = this.getModel().config.docs[sectionTitle].doc;
  ...
  buildBoolean(sectionTitle, availableOptions) {

    let section = this.buildSection(sectionTitle);

    for (const key of Object.keys(availableOptions)) {
      ...
      checkbox.checked = availableOptions[key]._active;
      checkbox.__ternjs_key = key;
      checkbox.addEventListener('change', (e) => {

        availableOptions[e.target.__ternjs_key]._active = e.target.checked;
