...
export default class Config {
  ...
  mergeConfigObjects(obj1, obj2) {
    ...
    return this.manager.helper._.deepExtend({}, obj1, obj2);
  }
  ...
  buildNewConfig() {
    ...
    if (!this.manager.helper._.isEmpty(this.config.libs)) {
    ...
    if (this.projectConfig && !this.manager.helper._.isEmpty(this.projectConfig.plugins)) {
